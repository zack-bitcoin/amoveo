...
#make a bet.
curl -i -d '["oracle_bet", 1, 2, 269]' http://localhost:3011 #slightly higher amount than the minimum
# 2 means we are betting that it is a bad question.
sleep 1
...
#curl -i -d '["trade", 0, 1, 1, 20, [127,0,0,1], 3020]' http://localhost:3011
#curl -i -d '["trade", 0, 2, 2, 20, [127,0,0,1], 3020]' http://localhost:3021
