...
class LightningTest(ApiUser):
    def test_payments(self):
        ...
        self.new_channel_with_server(DEV_1_INT, [[127, 0, 0, 1], 3030, 1, 10000, 10001, 50, 4], sleep=0.02)
        self.sync(DEV_2_INT, [[127, 0, 0, 1], 3030], sleep=0.02)
        self.new_channel_with_server(DEV_2_INT, [[127, 0, 0, 1], 3030, 2, 10000, 10001, 50, 4], sleep=0.02)
        self.sync(DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.02)

        self.channel_spend(DEV_1_INT, [[127, 0, 0, 1], 3030, 777], sleep=0.02)

        self.lightning_spend(DEV_1_INT, [[127, 0, 0, 1], 3030, pub1, 4, 10], sleep=0.02)
        self.pull_channel_state(DEV_2_INT, [[127, 0, 0, 1], 3030], sleep=0.02)
        self.pull_channel_state(DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.02)

        pub3 = 'BIVZhs16gtoQ/uUMujl5aSutpImC4va8MewgCveh6MEuDjoDvtQqYZ5FeYcUhY/QLjpCBrXjqvTtFiN4li0Nhjo='
        self.lightning_spend(DEV_2_INT, [[127, 0, 0, 1], 3030, pub3, 4, 10], sleep=0.02)
        self.pull_channel_state(DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.02)
        self.pull_channel_state(DEV_2_INT, [[127, 0, 0, 1], 3030], sleep=0.02)
