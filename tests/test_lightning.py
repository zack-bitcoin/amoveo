...
class LightningTest(ApiUser):
    def test_payments(self):
        self.sync(DEV_1_INT, [[127, 0, 0, 1], 3020], sleep=0.03)
        ...
        self.request("dump_channels", DEV_3_INT, [], sleep=0.03)
        self.load_key(DEV_2_INT, [pub1, priv1, brainwallet], sleep=0)
        self.load_key(DEV_3_INT, [pub2, priv2, brainwallet], sleep=0.03)
        self.create_account(DEV_1_INT, [pub1, 1000000000], sleep=0.03)
        self.create_account(DEV_1_INT, [pub2, 1000000000], sleep=0.03)

        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.03)
        #self.sync(DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.03)
        ...
        self.lightning_spend(DEV_1_INT, [[127, 0, 0, 1], 3030, pub1, 4, 10], sleep=0.03)
        self.pull_channel_state(DEV_2_INT, [[127, 0, 0, 1], 3030], sleep=0.03)
        self.pull_channel_state(DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.03)

        pub3 = 'BIVZhs16gtoQ/uUMujl5aSutpImC4va8MewgCveh6MEuDjoDvtQqYZ5FeYcUhY/QLjpCBrXjqvTtFiN4li0Nhjo='
        self.lightning_spend(DEV_2_INT, [[127, 0, 0, 1], 3030, pub3, 4, 10], sleep=0.03)
        self.pull_channel_state(DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.03)
        self.pull_channel_state(DEV_2_INT, [[127, 0, 0, 1], 3030], sleep=0.03)
