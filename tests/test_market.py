...
class MarketTest(ApiUser):
    def test_market(self):
        self.sync(DEV_1_INT, [[127, 0, 0, 1], 3020], sleep=5)
        ...
        self.create_account(DEV_1_INT, [pub2, 10], sleep=0.04)
        self.sync(DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.04)
        self.sync(DEV_2_INT, [[127, 0, 0, 1], 3030], sleep=0.04)
        self.request('new_channel_with_server', DEV_1_INT, [[127, 0, 0, 1], 3030, 17, 10000, 10001, 50, 4], sleep=0.04)
        self.sync(DEV_2_INT, [[127, 0, 0, 1], 3030], sleep=0.04)
        ...
        self.request('new_question_oracle', DEV_1_INT, [0, 'aXMgMisyPTQ/', 1], sleep=0.04)
        self.request('mine_block', DEV_1_INT, [1, 1], sleep=0.04)
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.04)
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3020], sleep=0.04)
        ...
        self.request('trade', DEV_1_INT, [3000, 1, 1, 2, 20, [127,0,0,1], 3030], sleep=0.04)
        self.request('trade', DEV_2_INT, [6000, 2, 2, 2, 20, [127,0,0,1], 3030], sleep=0.04)
        self.request('trade', DEV_2_INT, [8000, 2, 2, 2, 20, [127,0,0,1], 3030], sleep=0.04)
        self.request('market_match', DEV_3_INT, [2], sleep=0.04)
        ...
        self.request('mine_block', DEV_1_INT, [11, 1], sleep=0.04)
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.04)
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3020], sleep=0.04)
    #def dont_doit():
        self.request('oracle_close', DEV_1_INT, [2], sleep=0.04)
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.3)
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3020], sleep=0.3)
        self.request('settle_bets', DEV_3_INT, [], sleep=0.04)
        self.request('oracle_shares', DEV_1_INT, [1], sleep=0.04)
        self.request('oracle_shares', DEV_1_INT, [2], sleep=0.04)
        self.request('oracle_unmatched', DEV_1_INT, [1], sleep=0.04)
        self.request('oracle_unmatched', DEV_1_INT, [2], sleep=0.04)
        self.request('pull_channel_state', DEV_1_INT, [[127,0,0,1], 3030], sleep=0.04)
        self.request('pull_channel_state', DEV_2_INT, [[127,0,0,1], 3030], sleep=0.04)
