...
class MarketTest(ApiUser):
    def test_market(self):
        ...
        self.request('trade', DEV_1_INT, [6000, 1, 1000, oid, 0, 20, [127,0,0,1], 3030], sleep=0.04)
        self.request('trade', DEV_1_INT, [6001, 1, 1000, oid, 0, 20, [127,0,0,1], 3030], sleep=0.04)
        self.request('trade', DEV_2_INT, [6000, 2, 1000, oid, 0, 20, [127,0,0,1], 3030], sleep=0.04)
        self.request('trade', DEV_2_INT, [6001, 2, 1000, oid, 0, 20, [127,0,0,1], 3030], sleep=0.04)
        #self.request('trade', DEV_1_INT, [6000, 2, 2, oid, 0, 20, [127,0,0,1], 3030], sleep=0.04)
        #self.request('trade', DEV_1_INT, [8000, 2, 2, oid, 0, 20, [127,0,0,1], 3030], sleep=0.04)
        #self.request('trade', DEV_1_INT, [9000, 2, 1, oid, 0, 20, [127,0,0,1], 3030], sleep=0.04)
