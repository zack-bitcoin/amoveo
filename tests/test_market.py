...
class MarketTest(ApiUser):
    def test_market(self):
        self.request('mine_block', DEV_1_INT, [1, 1000000], sleep=0.4)
        ...
        self.request('new_channel_with_server', DEV_1_INT, [[127, 0, 0, 1], 3030, 17, 10000, 9999, 50, 4, 1000], sleep=0.04)
        self.sync(DEV_2_INT, [[127, 0, 0, 1], 3030], sleep=0.2)
        self.request('new_channel_with_server', DEV_2_INT, [[127, 0, 0, 1], 3030, 27, 10000, 9999, 50, 4, 1000], sleep=0.04)
        ...
        self.request('mine_block', DEV_1_INT, [10, 100000], sleep=1)
        ...
        self.request('mine_block', DEV_1_INT, [11, 1000000], sleep=1)
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.2)
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3020], sleep=0.2)
        ...
        self.request('mine_block', DEV_1_INT, [11, 10000], sleep=1)
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.2)
        self.request('sync', DEV_1_INT, [[127, 0, 0, 1], 3020], sleep=0.2)
