...
class MarketTest(ApiUser):
    def test_market(self):
        ...
        self.request('new_channel_with_server', DEV_1_INT, [[127, 0, 0, 1], 3030, 17, 10000, 10001, 50, 4], sleep=0.1)
        self.sync(DEV_2_INT, [[127, 0, 0, 1], 3030], sleep=0.3)
        self.request('new_channel_with_server', DEV_2_INT, [[127, 0, 0, 1], 3030, 27, 10000, 10001, 50, 4], sleep=0.1)
        self.sync(DEV_1_INT, [[127, 0, 0, 1], 3030], sleep=0.1)
        ...
        self.request('new_question_oracle', DEV_1_INT, [0, 'aXMgMisyPTQ/', 1], sleep=2)
    ...
    #def dont_doit():
        ...
        self.request('mine_block', DEV_1_INT, [11, 1], sleep=3)
