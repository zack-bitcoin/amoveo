...
[Amoveo has a working light node in the browser](http://139.59.144.76:8080/wallet.html).
...
Amoveo has off-chain markets with order books and single-price batches in the testnet. [You can see graphs of the market state here](http://139.59.144.76:8080/explorer.html)
