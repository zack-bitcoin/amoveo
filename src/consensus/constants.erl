...
default_port()   -> 8040.
key_length()     -> 48.        %so at most, we could store 16^11 =~ 17.6 trillion accounts and channels.
...
block_creation_maturity() -> 100. %10.%testing
...
%Missing this ones (Michael Padilla)
account_padding() -> 1.
