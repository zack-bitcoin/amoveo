-module(block_tree_old).
-behaviour(gen_server).
-export([start_link/0,code_change/3,handle_call/3,handle_cast/2,handle_info/2,init/1,terminate/2, 
	 long_test/0,test/0,write/1,top/0,read/1,read_int/2,read_int/1,secret/4,account/1,account/2,account/3,channel/2,channel/3,channel/1,absorb/1,is_key/1,height/1,height/0,txs/1,txs/0,block/0,block/1,buy_block/2,empty_block/0,total_coins/0,total_coins/1, buy_block/0, block_number/1, block2txs/1, block_root/1,backup/1,x_to_block/1,check/0,reset/0,creation_cost/1,mine/1]).
-record(block, {acc = 0, number = 0, hash = "", txs = [], difficulty = constants:initial_difficulty(), total_coins = constants:initial_coins(), db_root = <<>>}).
...
buy_block(Txs, TotalCoins, BlockGap) ->
    ...
    Block = #block{txs = Txs, hash = PHash, number = N, total_coins = TotalCoins, db_root = DBR},
    keys:sign(Block).
mine(_NewBlock) ->
