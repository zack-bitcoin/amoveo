...
test(1) ->
    ...
    Dict2 = (tx_pool:get())#tx_pool.dict,
    Ctx2 = spend_tx:make_dict(NewPub, 10, Fee, constants:master_pub(), Trees, Dict2),
    Stx2 = keys:sign(Ctx2),
    absorb(Stx2),
    Trees21 = (tx_pool:get())#tx_pool.trees,
    Dict21 = (tx_pool:get())#tx_pool.dict,
    Ctx21 = spend_tx:make_dict(NewPub, 10, Fee, constants:master_pub(), Trees, Dict21),
