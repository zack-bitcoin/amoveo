...
function human_language() {
    return {"light_title": {"cn": "Amoveo 轻钱包",
            ...
            "discuss_on_reddit": {"cn": "在 reddit 上讨论",
                                  ...
                                  "tp": "kulupu Reddit",
                                  "sp": "hablar de Amoveo con Reddit"},
            "blockchain": {"cn": "区块链",
                           "en": "blockchain ",
                           "tp": "mani sin",
            ...
            "win_if": {"cn": "??",
                       ...
                       "sp": "si el resultado es esto, vas a ganar: "},
            "cancel": {"cn": "取消",
                       "en": "cancel ",
                       "tp": "wile ala",
                       "sp": "cancelar"},
            ...
            "save_confirm": {"cn": "通道状态已保存",
                             ...
                             "sp": "el datos del canal se guardan."},
            ...
            "server_balance": {"cn": "??",
                               "en": "server balance",
                               "tp": "ona jo",
                               "sp": "cuantos tienes el servidor "},
            "check_channel": {"cn": "检查账户余额",
                              "en": "check channel balance",
                              "tp": "o toki e mute jo",
                              "sp": "mira cuantos tiene el canal"},
            "markets": {"cn": "市场",
                        "en": "markets",
                        "tp": "esun mute",
                        "sp": "mercados"},
            "markets_link": {"cn": "可以在下边查看可用的市场",
                             ...
                             "sp": "mira los marcados aqui"},
            "trade_type": {"cn": "贸易类型",
                           "en": "trade type",
                           "tp": "lon ala lon",
                           "sp": "typo de intercambio"},
            "make_bet": {"cn": "打个赌",
                         "en": "make bet ",
                         "tp": "pali e ??",
                         "sp": "crear intercambio"},
            "finalize_bets": {"cn": "检查是否有赌局已经完成",
                              "en": "check if any bets have been settled",
                              "tp": "lukin e ?? pini",
                              "sp": "mira si unos intercambios estan terminaron"},
            "gather_bets": {"cn": "汇集赌注",
                            "en": "combine bets in opposite directions to recover money from the market ",
                            "tp": "alasa e ??",
                            "sp": "combinar los intercambios para obtener dinero del mercado "},
            "refresh_bets": {"cn": "更新链下资产余额",
                             "en": "update balance of off-chain assets ",
                             "tp": "lukin e ?? sin",
                             "sp": "actualizar saldo de intercambios en el canal "},
            ...
            "more_headers": {"cn": "获取更多的头信息",
                             ...
                             "sp": "obtener mas datos del cadena de bloques"},
            "height": {"cn": "高度",
                       "en": "height ",
                       "tp": "nanpa suli",
                       "sp": "altura"},
            ...
            "save_key": {"cn": "保存私钥到文件",
                         ...
                         "tp": "jo e poki",
                         "sp": "guardar la llave privada"},
            "get_key": {"cn": "从文件中读取密钥",
                        "en": "get key from file ",
                        "tp": "alasa e poki",
                        "sp": "obtener la llave del archivo"},
            "make_key": {"cn": "生成新的密钥对",
                         "en": "generate new keys ",
                         "tp": "o pali poki sin",
                         "sp": "crear nueva llave"},
            ...
            "key_warning": {"cn": "这将会删除旧的密钥对. 其中的余额也将被删除",
                            ...
                            "sp": "si no guardas, vas a destruir la llave."},
            "stop_mining": {"cn": "停止挖矿",
                            "en": "stop mining",
            ...
            "start_mining": {"cn": "开始挖矿 (注意: 使用电脑或者笔记本, 不要用手机. 想要持续挖矿的话页面不能关闭)",
                             ...
                             "tp": "o alasa mani. ",
                             "sp": "comenzar de minar (cuidado: solo usas un laptop o computadora. no usa celular para minar.)"},
            "blocks_found": {"cn": "??",
                             "en": "blocks found",
                             "tp": "pini la alasa e mute nanpa ",
                             "sp": "recompensas obtenidas"}
           };
}
