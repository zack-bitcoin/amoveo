...
function keys_function1() {
    ...
    save_name.value = "amoveo私钥";
    var save_button = document.createElement("input");
    save_button.type = "button";
    save_button.value = "保存私钥到文件";
    save_button.onclick = save_keys;
    var file_selector = document.createElement("input");
    file_selector.type = "file";
    file_selector.onchange = load_keys;

    var load_text = document.createTextNode("从文件中读取密钥");
    ...
    new_pubkey_button.value = "生成新的密钥对";
    ...
    function update_pubkey() {
        pub_div.innerHTML = ("你的公钥: ").concat(pubkey_64());
    }
    function new_keys_check() {
        ...
        warning.innerHTML = "这将会删除旧的密钥对. 其中的余额也将被删除";
