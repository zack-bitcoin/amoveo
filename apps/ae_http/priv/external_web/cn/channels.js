...
function channels1() {
    ...
    save_name.value = "amoveo 通道状态";
    var save_button = document.createElement("input");
    save_button.type = "button";
    save_button.value = "保存通道数据到文件";
    ...
    function channel_warning() {
        channel_warning_div.innerHTML = "通道状态需要保存!~~~~~~~";
    }
    function save_channel_data() {
        ...
        channel_warning_div.innerHTML = "通道状态已保存";
    }
    ...
    function refresh_channels_interfaces(pubkey) {
        ...
        if (v == undefined) {
            ...
            var button_text_node = document.createTextNode("创建通道");
            ...
            amount_info.innerHTML = "锁定在通道中的数量: ";
            ...
            trade_type_info.innerHTML = "贸易类型 (既不是 'true' 也不是 'false'): ";
            ...
            oid_info.innerHTML = "市场 id: ";
            div.appendChild(oid_info);
            div.appendChild(oid);

            var button = document.createElement("BUTTON");
            button.id = "button";
            var buttonText = document.createTextNode("打个赌");
            ...
            bet_update_button.value = "检查是否有赌局已经完成";
            ...
            combine_cancel_button.value = "汇集赌注";
            ...
            list_bets_button.value = "更新链下资产余额";
