...
function wallet_doit1() {
    ...
    function write_header(header) {
        ...
        if (acc_difficulty > top_diff) {
            ...
            top_header = header;
            wallet_text.innerHTML = JSON.stringify({"高度": header[1], "总工作量":(Math.floor(header[9]/100000000))});
        }
