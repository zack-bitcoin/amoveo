...
function channels_main() {
	...
	console.log(JSON.stringify(l));
        var sc = market_contract(type_final, expires, price_final, server_pubkey, period, amount_final, oid_final, headers_object.top()[1]);// SCALAR might need to use scalar_market_contract instead.
        var cd = read(server_pubkey);
