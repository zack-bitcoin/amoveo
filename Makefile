...
config/prod/sys.config: config/sys.config.tmpl
    ...
    {peers, [{{31,130,148,203},8080},{{159,223,85,216},8080},{{159,65,126,146},8080},{{64,227,21,70},8080},{{46,101,81,5},8080},{{43,133,42,108},8080}]},\
    {pools, [{{31,130,148,203},8080},{{159,223,85,216},8080},{{159,65,126,146},8080},{{43,133,42,108},8080}]},\
